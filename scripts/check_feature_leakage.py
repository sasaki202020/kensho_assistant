...
# kensho_assistant 上のステージング環境か、boatrace-ai リポジトリ単体かを自動判定する。
# kensho_assistant: scripts/ の 2 つ上が kensho_assistant ルートで、_boatrace_staging/ が存在する
# boatrace-ai 単体: scripts/ の 1 つ上がリポジトリルート
_HERE = Path(__file__).parent.parent
_STAGING = _HERE / "_boatrace_staging"
_ROOT = _STAGING if _STAGING.exists() else _HERE
